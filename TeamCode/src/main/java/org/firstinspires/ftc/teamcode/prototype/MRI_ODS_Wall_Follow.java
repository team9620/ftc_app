...
public class MRI_ODS_Wall_Follow extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        mLeft = hardwareMap.dcMotor.get("left motor");
        mRight = hardwareMap.dcMotor.get("right motor");
        ...
        while (opModeIsActive()) {
            ...
            //See the video explanation on the Modern Robotics YouTube channel, the ODS product page, or modernroboticsedu.com.
               ...
               // mRight.setPower(((-0.2)*odsReadingLinear)+.338);
                //mLeft.setPower(((0.2)*odsReadingLinear)-.138);
            mRight.setPower(TurnCalc.WallDistR(odsReadingLinear));
            mLeft.setPower(TurnCalc.WallDistL(odsReadingLinear));
