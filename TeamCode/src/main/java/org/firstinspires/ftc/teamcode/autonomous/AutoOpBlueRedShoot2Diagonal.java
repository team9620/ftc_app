...
@Autonomous(name="Blue.Left.Diagonal.Shoot.2", group="AutoOp")
//@Disabled
public class AutoOpBlueRedShoot2Diagonal extends LinearOpMode {
    public static final String TAG = "Blue.Left.Diagonal.Shoot.2";
